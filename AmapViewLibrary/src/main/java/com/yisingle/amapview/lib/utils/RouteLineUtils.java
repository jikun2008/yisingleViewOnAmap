...
//     * @param tmcList
//     */
//    public static List<BasePolyLineView> addTrafficStateLine(@NonNull Context context, @NonNull AMap amap, @NonNull List<TMC> tmcList, @NonNull RouteLineParam routeLineParam) {
//
...
//
//
//    public static List<BasePolyLineView> changeTrafficStateLine(@NonNull Context context, @NonNull AMap amap, @NonNull List<BasePolyLineView> polyLineViewList, @NonNull List<TMC> tmcList, @NonNull RouteLineParam routeLineParam) {
//
//        List<TrafficStateData> list = buildTrafficListData(tmcList);
...
//     * @return
//     */
//    public static BasePolyLineView addArrowLine(@NonNull Context context, @NonNull AMap amap, @NonNull List<LatLng> latLngList, @NonNull RouteLineParam routeLineParam) {
//
//
//        BasePolyLineView basePolyLineView = new BasePolyLineView.Builder(context, amap)
//                //设置路线上的点
...
//
//
//    public static BasePolyLineView addDefaultLine(@NonNull Context context, @NonNull AMap amap, @NonNull List<LatLng> latLngList, @NonNull RouteLineParam routeLineParam) {
//
//        BasePolyLineView basePolyLineView = new BasePolyLineView.Builder(context, amap)
//                //设置路线上的点
//                .setPoints(latLngList)
